...
static void proto_submit_command(struct proto_pcie_dev *d, struct proto_pcie_command *cmdbuf)
{
    ...
    if (d->simulated) {
        /* Deterministic completion for userspace testing. */
